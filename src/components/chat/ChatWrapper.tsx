    ...
    <div className="relative min-h-full bg-zinc-50 flex divide-y divide-zinc-200 flex-col justify-between gap-2">
      <div className="flex-1 flex justify-center items-center flex-col mb-28">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-zinc-500 text-sm">
            Your {isSubscribed ? <span className="font-medium">Pro</span> : <span className="font-medium">Free</span>} plan supports {
              isSubscribed ? <span>upto 25 pages per PDF (or upto 16MB)</span> : <span>upto 5 pages per PDF (or upto 4MB).</span>
            }
          </p>
