                ...
                <div className="flex items-center justify-center h-full w-full">
                    <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-full rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                        ...
                        <div className="flex flex-col items-center justify-center pt-5 pb-6">
                            ...
                            <p className="text-xs text-zinc-500">PDF ({isSubscribed? <span>(upto 16MB)</span> : <span>(upto 4MB)</span>}</p>
                        </div>
                        ...
                        <input type="file" id='dropzone-file' className='hidden'></input>
                    </label>
                </div>
            </div>
        )}
